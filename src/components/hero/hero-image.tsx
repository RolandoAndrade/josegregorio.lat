  ...
  return (
    <div
      ...
      <div className="relative aspect-[366/729] mx-auto max-w-[366px]">
        ...
        <Image loading={'eager'} width={500} height={500} src={'/main.svg'} alt={'AI José Gregorio Welcome Message Screenshot'} className={'absolute inset-0 w-full h-full object-cover'} />
      </div>
    </div>)
}